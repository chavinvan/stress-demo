...
values=list(ejemplos_dict['email'].values())
...
with st.sidebar:
    ...
    "Select Mail",
    (ejemplos_key))
    areaText = st.text_area("EMail",ejemplos_dict[option],height=180)
    
    submit = st.button(label=":white[Calculate Stress]",type="primary")
